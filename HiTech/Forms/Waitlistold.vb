...
Public Class Waitlistold
    ...
    Public Sub fill()
        ...
        Try
            ...
            dr = dn.ExecuteScalar
            gt = New SqlCommand("SELECT DISTINCT waitlist.id, waitlist.pid, waitlist.pname, 'بدون', waitlist.wstat FROM waitlist, [check] WHERE [check].doctor = '" & dr & "' AND wstat = 'wait' AND waitlist.invno = 0", con)
