...
Public Class QtyIn
    ...
    Public Sub fill()
        ...
        Try
            ...
            data.Rows.Clear()
            While rdr.Read
                data.Rows.Add({rdr("invno"), rdr("sdate"), rdr("total")})
            End While
            rdr.Close()
            cclose()
    ...
    Private Sub data_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles data.CellClick
        If data.RowCount > 0 Then
            If e.ColumnIndex = 3 Then
                Importdet.invno.Text = data.CurrentRow.Cells(0).Value
                Importdet.frmtitle.Text = "تفاصيل الوارد"
                Importdet.Show()
                If Importdet.WindowState = FormWindowState.Minimized Then
                    Importdet.WindowState = FormWindowState.Normal
                End If
                Importdet.BringToFront()
