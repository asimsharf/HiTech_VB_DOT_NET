...
Public Class DocNewcheck
    ...
    Private Sub Clinics_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            copen()
            cmd = New SqlCommand("SELECT dept FROM doctors WHERE uname = '" & un & "'", con)
            depart.Text = cmd.ExecuteScalar.ToString
            cclose()
        Catch ex As Exception
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        Try
            ...
            With cmd.Parameters
                ...
                .Add(New SqlParameter("@d", depart.Text))
                .Add(New SqlParameter("@e", drname.Text))
            ...
            With wl.Parameters
                ...
                .Add(New SqlParameter("@f", drname.Text))
                wl.ExecuteNonQuery()
            End With
    ...
    Private Sub serch_Click(sender As Object, e As EventArgs)
        Searchpatient.from.Text = "newcheck"
    ...
    Private Sub serch2_Click(sender As Object, e As EventArgs) Handles serch2.Click
        ...
        copen()
        Try
            cmd = New SqlCommand("SELECT snamear, sprice FROM services WHERE scode = '" & scode.Text & "' AND dept = '" & depart.Text & "'", con)
    ...
    Private Sub dept_SelectedIndexChanged(sender As Object, e As EventArgs)
        sqty.Value = 1
        stax.Text = 0
        sdiscount.Text = 0
        stotal.Text = 0
